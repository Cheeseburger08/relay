...
class RelayPcm extends AudioWorkletProcessor {
  constructor() {
    ...
    this.port.onmessage=({data})=>{
      ...
      if(this.count+pcm.length>3200){
        this.count=0;this.read=this.write;this.playing=false;
        this.port.postMessage({type:'error',message:'Playback fell behind; audio stopped.'});return;
      }
